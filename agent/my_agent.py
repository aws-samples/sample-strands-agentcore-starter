...
async def invoke(payload, context):
    ...
    agent = Agent(
        model=model_id,
        system_prompt="You are a helpful AI assistant with memory. You can remember previous conversations within the same session. You have access to various tools: web search via DuckDuckGo, URL content fetching, weather information for US locations, calculator for math, and current time/date.",
        hooks=hooks,
        tools=[
            ddg_web_search,
            fetch_url_content,
